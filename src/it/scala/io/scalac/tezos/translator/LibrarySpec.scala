  ...
  "Library routes" should {
    ...
    "store proper payload" should {
      "full filed payload " in {
        val properPayload = LibraryEntryRoutesDto("vss", Some("Mike"), Some("name@service.com"), Some("Some thing for some things"), "micheline", "michelson") // with all of some as none return 500
