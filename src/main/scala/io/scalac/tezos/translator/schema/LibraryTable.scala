...
class LibraryTable(tag: Tag) extends Table[LibraryEntryDbDto](tag, "library") {
  ...
  def author: Rep[Option[String]] = column[Option[String]]("author", NotNull, O.SqlType("TEXT"))

  def email: Rep[Option[String]] = column[Option[String]]("email", O.SqlType("TEXT"))

  def description: Rep[Option[String]] = column[Option[String]]("description", NotNull, O.SqlType("TEXT"))
